    ...
    <section id="login-form" class="py-5">
        <div class="container-sm">
            <div class="row justify-content-center">
                <div class="col-4">
                    <h2 class="section-title text-uppercase">Sign Up</h2>


                    <form id="form" class="form-group flex-wrap" action="signup" method="post">
                        <div class="text-danger">${warn}</div>
                        <div class="col-12 pb-3">
                            <label>Username *</label>
                            <input type="text" name="username" value="" 
                                   placeholder="Write your username / email address here"
                                   class="form-control" required="" pattern="^[a-zA-Z0-9]{6,}$"
                                   title="Username cannot contain special characters or spaces and must be at least 6 characters a-z A-Z 0-9"
                                   oninvalid="setCustomValidity('Username cannot contain special characters or spaces and must be at least 6 characters a-z A-Z 0-9')"
                        ...
                        <div class="col-12 pb-3">
                            ...
                            <input required="" type="password" name="repassword" value="" placeholder="Enter your re-password" class="form-control">
                        </div>

                        <div class="col-12 pb-3">
                            <label>Name *</label>
                            <input type="text" required="" name="name" value="" placeholder="Enter your name" class="form-control">
                        </div>
                        <div class="col-12 pb-3">
                            <label>Address *</label>
                            <input type="text" required="" name="address" value="" placeholder="Enter your address" class="form-control">
                        </div>
                        <div class="col-12 pb-3">
                            <label>Phone *</label>
                            <input type="text" required="" pattern="[0-9]{10}" 
                                   name="phone" value="" placeholder="Enter your phone" 
                                   class="form-control" title="The phone number must have exactly 10 digits"
                                   oninvalid="setCustomValidity('The phone number must have exactly 10 digits')"
                                   oninput="setCustomValidity('')">
                        </div>
                        <div class="col-12 pb-3">
                            <label>Email *</label>
                            <input type="email" required="" name="email" value="" placeholder="Enter your email" class="form-control">
                        </div>

                        <div class="col-12">
                            <button type="submit" name="submit" class="btn btn-dark btn-large text-uppercase pb-3">Sign Up</button>
                        </div>
                    </form>
                </div>
            </div>
