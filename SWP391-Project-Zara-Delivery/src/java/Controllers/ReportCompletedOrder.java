...
public class ReportCompletedOrder extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String email = OrderDAO.INSTANCE.getEmailbyOrderId(orderId);
        List<OrderDetail> orderDetails = (List) OrderDetailDAO.INSTANCE.getListDetailByOrderId(orderId);

        StringBuilder productNames = new StringBuilder();
        for (OrderDetail detail : orderDetails) {
            //productNames.append(detail.getName()).append(", ");, 
        }
...
// Loại bỏ dấu phẩy và khoảng trắng cuối cùng nếu có
        ...
        try {
            // Sử dụng đối tượng email để gửi thông tin
            email e = new email();
            e.send(email, "Notice of order cancellation", "Your order was cancelled because the shipper couldn't contact with you\n"
                    + "Your order detail:\n"
                    + "Your Products: " + productNames.toString());
