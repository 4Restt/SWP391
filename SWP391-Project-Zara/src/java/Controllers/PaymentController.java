...
public class PaymentController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String vnp_TmnCode = StaticMeThod.vnp_TmnCode;
        Map<String, String> vnp_Params = new HashMap<>();
        vnp_Params.put("vnp_Version", StaticMeThod.vnp_Version);
        vnp_Params.put("vnp_Command", StaticMeThod.vnp_Command);
        vnp_Params.put("vnp_TmnCode", vnp_TmnCode);
        vnp_Params.put("vnp_Amount", String.valueOf(total));
        vnp_Params.put("vnp_CurrCode", "VND");
        vnp_Params.put("vnp_ReturnUrl", StaticMeThod.vnp_ReturnUrl);
        ...
        String vnp_SecureHash = StaticMeThod.hmacSHA512(StaticMeThod.secretKey, hashData.toString());
