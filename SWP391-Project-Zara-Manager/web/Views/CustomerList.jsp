...
<html lang="en">
                            ...
                            <div class="col-12 mt-4">
                                <div class="">
                                    <table id="userTable" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                        <c:forEach items="${listCustomer}" var="lc" varStatus="loop">
                                            <tr>
                                                <th class="p-3">${loop.index + 1}</th>
                                                <td class="p-3">
                                                    <a href="#" class="text-dark">
                                                        <div class="d-flex align-items-center">
                                                            <img src="${lc.getImage()}" class="avatar avatar-md-sm rounded-circle shadow" alt="">
                                                            <span class="ms-2">${lc.getName()}</span>
                                                        </div>
                                                    </a>
                                                </td>
                                                <td class="p-3">${lc.getEmail()}</td>
                                                <td class="p-3">${lc.getPhone()}</td>                                              
                                                <td class="p-3">${lc.getDate()}</td>
                                                <td class="p-3 ${lc.getStatus() == 'Activated' ? 'text-success' : 'text-danger'}">${lc.getStatus()}</td> 
                                                <td class="text-end p-3">
                                                    <a href="#" class="btn btn-icon btn-pills btn-soft-primary" data-bs-toggle="modal" data-bs-target="#viewcustomer${lc.getId()}"><i class="uil uil-eye"></i></a>
                                                    <a href="#" class="btn btn-icon btn-pills btn-soft-success" data-bs-toggle="modal" data-bs-target="#acceptcustomer${lc.getId()}"><i class="uil uil-check-circle"></i></a>
                                                    <a href="#" class="btn btn-icon btn-pills btn-soft-danger" data-bs-toggle="modal" data-bs-target="#cancelcustomer${lc.getId()}"><i class="uil uil-times-circle"></i></a>
                                                    <a href="#" class="btn btn-icon btn-pills btn-soft-muted" data-bs-toggle="modal" data-bs-target="#editcustomer${lc.getId()}"><i class="uil uil-user"></i></a>
                                                </td>
                                            </tr>
                                        </c:forEach>    
    ...
    <c:forEach items="${listCustomer}" var="lc" varStatus="loop">
        <div class="modal fade" id="viewcustomer${lc.getId()}" tabindex="-1" aria-labelledby="exampleModalLabel${lc.getId()}" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header border-bottom p-3">
                        <h5 class="modal-title" id="exampleModalLabel${lc.getId()}">Staff Detail</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body p-3 pt-4">
                        <div class="d-flex align-items-center">
        ...
        <div class="modal fade" id="acceptcustomer${lc.getId()}" tabindex="-1" aria-labelledby="exampleModalLabel${lc.getId()}" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-body py-5">
                        <div class="text-center">
                            ...
                            <div class="mt-4">
                                ...
                                <div class="mt-4">
                                    <a href="customerstatus?action=active&id=${lc.getId()}" class="btn btn-soft-success">Active</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="modal fade" id="cancelcustomer${lc.getId()}" tabindex="-1" aria-labelledby="exampleModalLabel${lc.getId()}" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-body py-5">
                        <div class="text-center">
                            ...
                            <div class="mt-4">
                                ...
                                <p class="para-desc mx-auto text-muted mb-0">Great doctor if you need your family member to get immediate assistance, emergency treatment.</p>
                                <div class="mt-4">
                                    <a href="customerstatus?action=deactive&id=${lc.getId()}" class="btn btn-soft-danger">Cancel</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <script>
            function uploadImage${lc.getId()}() {
                var formData = new FormData($('#uploadForm${lc.getId()}')[0]);
                $.ajax({
                    type: 'POST',
                    ...
                    success: function (response) {
                        ...
                        var imgSrc = response ? response : '${lc.getImage()}';
                        $(('#imgAfterUp${lc.getId()}')).attr('src', imgSrc);
        ...
        <div class="modal fade" id="editcustomer${lc.getId()}" tabindex="-1" aria-labelledby="exampleModalLabel${lc.getId()}" aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header border-bottom p-3">
                        ...
                        <div class="card border-0 p-4 rounded shadow">
                            <div class="row align-items-center">
                                <div class="col-lg-2 col-md-4">
                                    <img id ="imgAfterUp${lc.getId()}" src="${lc.getImage()}" 
                            ...
                            <form id="uploadForm${lc.getId()}" enctype="multipart/form-data">
                                <div class="col-lg-6 col-md-12 text-lg-end text-center mt-4 mt-lg-0">
                                    ...
                                    <input type="text" name="imageBackUp" hidden="" value="${lc.getImage()}">

                                    <input type="button" class="btn btn-primary" value="Upload" onclick="uploadImage${lc.getId()}()">
                                    <a href="#" class="btn btn-soft-primary ms-2" id="removeButton">Remove</a>
                                </div><!--end col-->
                            </form>
                            <form method="post" action="editcustomer?id=${lc.getId()}">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            <label class="form-label">Name <span class="text-danger">*</span></label>
                                            <input name="name" id="name${lc.getId()}" type="text" class="form-control" value="${lc.getName()}">
                                        </div>
                                    </div><!--end col-->
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label class="form-label">Username</label>
                                            <input name="username" id="username${lc.getId()}" type="text" class="form-control" value="${lc.getAccount()}">
                                        </div> 
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input name="email" id="email${lc.getId()}" type="email" class="form-control" value="${lc.getEmail()}">
                                        </div> 
                                    </div><!--end col-->
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label class="form-label">Password</label>
                                            <input name="password" id="password${lc.getId()}" type="text" class="form-control" value="${lc.getPassword()}">
                                        </div>
                                    </div><!--end col-->
                                    <div class=" col-md-6">
                                        <div class="mb-3">
                                            <label class="form-label">Phone <span class="text-danger">*</span></label>
                                            <input name="phone" id="phone${lc.getId()}" type="tel" class="form-control" value="${lc.getPhone()}">
                                        </div> 
                                    </div><!--end col-->
                                    ...
                                    <div class="col-lg-12">
                                        <div class="mb-3">
                                            ...
                                            <input name="address" type="text" class="flatpickr flatpickr-input form-control" value="${lc.getAddress()}">
                                        </div>
                                    </div><!--end col-->
                                    <input type="text" name="imageBackUp" hidden="" value="${lc.getImage()}">
