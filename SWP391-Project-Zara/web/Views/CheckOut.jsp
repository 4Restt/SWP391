            ...
            <div class="your-order mt-5">
              ...
              <div class="total-price">
                ...
                <div class="list-group mt-5 mb-3">
                  ...
                  <label class="list-group-item d-flex gap-2 border-0">
                      <input class="form-check-input flex-shrink-0" type="radio" name="payment" id="listGroupRadios3" value="vnpay" required="">
                    <span>
                      <strong class="text-uppercase">VNPAY</strong>
                      <small class="d-block text-body-secondary">Pay via VNPAY</small>
                    </span>
                  </label>
                </div>
