<%-- 
    Document   : change-phonenumber
    Created on : Feb 28, 2024, 3:56:24 PM
    Author     : dev
--%>
                    ...
                    <div class="col-md-3 pt-0">
                        <div class="list-group list-group-flush account-settings-links">
                            <a class="list-group-item list-group-item-action" style="font-weight: bold" data-toggle="list"
                               href="#account-general">Change Phone number</a>
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade active show" id="account-change-password" style="padding: 30px">
                                <form action="/SWP391-Project-Zara/changephone">
                                    <div class="card-body pb-2">
                                        <div class="form-group">
                                            <label class="form-label">New Phone number:  </label>
                                            <input id="newpass" type="text" name="newphone" class="form-control" required value="${newphone}">
                                        </div>
                                        <div class="form-group">
                                            <label class="form-label">Enter OTP: </label>
                                            <input id="OTP" type="text" name="OTP" class="form-control" ${newphone != null ? 'required' : 'readonly'}>
                                    ...
                                    <div class="text-right mt-3">
                                        ...
                                        <button type="button" class="btn btn-default" onclick="window.location.href = 'Views/change-phonenumber.jsp'">Cancel</button>
